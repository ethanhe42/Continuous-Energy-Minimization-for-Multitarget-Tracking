...
global detections scenario sceneInfo opt gtInfo globiter cemStartTime LOG_allens allmets2d allmets3d
...
while i < abs(length)                                      % while not finished
  ...
  if success                                         % if line search succeeded
    ...
    %   O U T P U T   %
    %%%%%%%%%%%%%%%%%%%
%     d=checkgrad('E',X,1e-3,stateInfo)
%     pause
...
%         fprintf('%s %6i;  Value %4.6e\r', S, i, f1);
        ...
        if opt.verbosity>=3            
            [EdetValue EdynValue EexcValue EappValue EperValue EregValue,EoriValue]=printEnergies(opt, i, X, P1);
            LOG_allens(globiter,:)=[EdetValue EdynValue EexcValue EappValue EperValue EregValue,EoriValue];
        
        
            printProgressMetrics(opt,sceneInfo,X,P1, i);
        end
        printMessage(3,'\n');
